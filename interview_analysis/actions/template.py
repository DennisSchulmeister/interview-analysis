...
class TemplateAction:
    ...
    _TEMPLATE_YAML: str = "\n".join(
        [
            ...
            "#",
            "#   # Optional: allow secondary topic assignments.",
            "#   # If true, the model may assign multiple topics to a statement, marking one as primary and others as secondary.",
            "#   # Secondary assignments include a short keyword note (shown in the transcript sheets).",
            "#   allow_secondary_assignments: false",
            "#",
            "#   # Optional: allow multiple primary topic assignments for long statements.",
            "#   # If true (default), multiple topics may be marked as primary for the same statement.",
            "#   # If false, the tool will keep exactly one primary and downgrade others to secondary.",
            "#   # Only has an effect when allow_secondary_assignments is true.",
            ...
            "#   strategy: segment",
            "#",
            "#   # Optional: fine-tune LLM instructions.",
            "#   llm_guidance:",
            "#     explain_assignments: false",
            "#     # Optional: language for rationale keywords (topics/orientations remain verbatim).",
            "#     # Examples: 'English', 'Deutsch', 'Français'.",
            "#     reasoning_language: null",
            "#     require_textual_evidence: true",
            "#     list_rejected_assignments: false",
